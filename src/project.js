            ...
            g = function(e) {
                ...
                return o(t, e), t.prototype.start = function() {}, t.prototype.update = function(e) {}, t.prototype.onCollisionEnter = function(e, t) {
                    if ("bazi" == e.node.group) {
                        ...
                        console.log('onCollisionEnter -> default node group')
                        ...
                        console.log('onCollisionEnter default  应该没用')
        ...
        var a = e("../common/PlayerInfo"),
            ...
            m = function(e) {
                ...
                return o(t, e), t.prototype.onLoad = function() {}, t.prototype.start = function() {
                    ...
                    var o = this;
                    if ("downwall" == n.node.group && (t.node.parent = cc.find("Canvas/fruitNode"), 0 == this.wallColl && (console.log(`碰到地面`), d.default.Instance.Play(5, !1, 1), this.wallColl++)), "fruit" == n.node.group) {
